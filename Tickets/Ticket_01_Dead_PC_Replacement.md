...
![Physical setup completed](Screenshots/Ticket_01/03_Physical_Setup_Completed.png)

![PXE network boot](Screenshots/Ticket_01/04_PXE_Boot_Server_Imaging.png)

![Domain login verification](Screenshots/Ticket_01/05_Domain_Login_Verification.png)

![PC shelf — replacement ready](Screenshots/Ticket_01/06_PC_Shelf_Replacement_Ready.png)

![Ship Manager — replacement desktop](Screenshots/Ticket_01/07_Ship_Manager_Replacement_Desktop.png)
...
![Asset record before unassignment](Screenshots/Ticket_01/08_Asset_Verification_Before_Unassignment.png)

![Asset record after unassignment](Screenshots/Ticket_01/09_Asset_Record_After_Unassignment.png)

![Resolved incident ticket](Screenshots/Ticket_01/10_Resolved_Incident_Ticket.png)
