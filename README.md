...
- Network Device Monitoring and Reboot
- Server Monitoring
...
- Time Zone Configuration and Clock Synchronization
...
This portfolio was completed using **ServiceDesk Simulator**, a Help Desk training platform, for learning purposes.
...
What is real is the troubleshooting process and the reasoning in each write-up, which is my own.
